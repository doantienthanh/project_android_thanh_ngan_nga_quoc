...
--
-- Table structure for table `chitietdonmuahang`
--
...
--
-- Dumping data for table `chitietdonmuahang`
--
...
(18, 130, 89, 'Dép Quai Ngang 3 Sọc- Bám Sàn Rất Tốt ', 410000, 2);
...
(129, 'Trần ĐInh Trọng', 1234565432, 'trongcte@gmail.com', 'CLB Ha Nội FC'),
(130, 'thanhdoandev@gmail.com', 946613608, 'thanhdoandev@gmail.com', 'thanhdoandev@gmail.com');
...
(7, 'thanhdoan', 'thanhdoandev@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', NULL);
...
(1, 'Giày', 'https://cf.shopee.vn/file/979c4e5ae75e449de2dd2c94c1200325'),
...
--
-- Table structure for table `sanphamflashsale`
--
...
--
-- Dumping data for table `sanphamflashsale`
--
...
--
-- Indexes for table `chitietdonmuahang`
--
...
--
-- Indexes for table `sanphamflashsale`
--
...
--
-- AUTO_INCREMENT for table `chitietdonmuahang`
--
ALTER TABLE `chitietdonmuahang`
...
--
-- AUTO_INCREMENT for table `sanphamflashsale`
--
ALTER TABLE `sanphamflashsale`
